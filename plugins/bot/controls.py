...
@Client.on_message(filters.command(["next", f"next@{Config.BOT_USERNAME}"]) & admin_filter & (filters.chat(Config.CHAT_ID) | filters.private | filters.chat(Config.LOG_GROUP)))
...
@Client.on_message(filters.command(["ps", f"ps@{Config.BOT_USERNAME}"]) & admin_filter & (filters.chat(Config.CHAT_ID) | filters.private | filters.chat(Config.LOG_GROUP)))
...
@Client.on_message(filters.command(["rs", f"rs@{Config.BOT_USERNAME}"]) & admin_filter & (filters.chat(Config.CHAT_ID) | filters.private | filters.chat(Config.LOG_GROUP)))
...
@Client.on_message(filters.command(["repeat", f"repeat@{Config.BOT_USERNAME}"]) & admin_filter & (filters.chat(Config.CHAT_ID) | filters.private | filters.chat(Config.LOG_GROUP)))
...
@Client.on_message(filters.command(["m", f"m@{Config.BOT_USERNAME}"]) & admin_filter & (filters.chat(Config.CHAT_ID) | filters.private | filters.chat(Config.LOG_GROUP)))
...
@Client.on_message(filters.command(["unm", f"unm@{Config.BOT_USERNAME}"]) & admin_filter & (filters.chat(Config.CHAT_ID) | filters.private | filters.chat(Config.LOG_GROUP)))
...
async def show_player(client, m: Message):
    ...
    if not data.get('dur', 0) or \
        data.get('dur') == 0:
        title="▶️ <b>Streaming [Live Stream](https://t.me/rsbro) !</b>"
    else:
        if Config.playlist:
